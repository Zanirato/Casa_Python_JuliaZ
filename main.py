...
class App(tk.Tk):
    ...
    def __init__(self):
        ...
        super().__init__()
        self.title("Controle de Estoque: Comidas Nordestinas")  # Define o título da janela.
        ensuredb()  # Garante que o banco de dados esteja criado e inicializado.
        self.currentuser = None  # Armazena dados do usuário logado.
        centralizarjanela(self, 400, 250)  # Centraliza a janela na tela.
        showlogin(self)
    ...
    def showmain(self):        
        ...
        ttk.Label(top, text=f"Usuário logado como: {self.currentuser.get('nome_completo','')}").pack(side="left")
